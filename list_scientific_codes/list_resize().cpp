...
void solve() {
   ...
   cout << "Лист #1" << endl;
   cout << "Сейчас изменяем размер первого листа " << endl;
   cout << "Введите новый размер первого листа и чем заполнить пустые ячейки" << endl;
   int g11, g12;
   cout << "Размер - ";
   cin >> g11;
   cout << "Чем заполнить пустые ячейки - ";
   cin >> g12;
   numbers1.resize(g11, g12); /// Изменили размер на g11 и если там не будет столько элементов то заполняем пустые ячейки g12
   cout << "Размер первого нового листа - " << numbers1.size() << endl;
   cout << "Выводим содержимое листа: ";
   for(int i : numbers1) {
     cout << i << " ";
   }
   cout << endl << endl;
   ...
   cout << "Лист #2" << endl;
   cout << "Сейчас изменяем размер второго листа " << endl;
   cout << "Введите новый размер второго листа и чем заполнить пустые ячейки" << endl;
   int g21, g31;
   cout << "Размер - ";
   cin >> g21;
   cout << "Чем заполнить пустые ячейки - ";
   cin >> g31;
   numbers2.resize(g21, g31); /// Изменили размер на g21 и если там не будет столько элементов то заполняем пустые ячейки g31
   cout << "Размер второго нового листа - " << numbers2.size() << endl;
   cout << "Выводим содержимое листа: ";
   for(int i : numbers2) {
     cout << i << " ";
   }
